...
from sklearn.metrics import mean_absolute_error, roc_auc_score, matthews_corrcoef, accuracy_score, f1_score, \
    mean_squared_error, r2_score

import torch
from torch.optim.lr_scheduler import CyclicLR
from CrabNet_spacegroup.utils import Lamb, Lookahead, RobustL1, BCEWithLogitsLoss, EDM_CsvLoader, Scaler, DummyScaler, \
    count_parameters
from CrabNet_spacegroup.optim import SWA
    ...
    def train(self):
        ...
        for i, data in enumerate(self.train_loader):
            ...
            y = y.to(self.compute_device,
                     dtype=data_type_torch,
                     non_blocking=True)
            space_group = space_group.to(self.compute_device,
                                         dtype=torch.float,
                                         non_blocking=True)

            output = self.model.forward(src, frac, space_group)
